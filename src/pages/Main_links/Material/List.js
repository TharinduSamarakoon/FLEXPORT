...
const List = () => {
    ...
    if (onSearchText !== "") {
      const filteredObject = Data.filter((item) => {
        return (
          ...
          item.material.toLowerCase().includes(onSearchText.toLowerCase())
        );
      });
  ...
  const onFormSubmit = (submitData) => {
    const { code, material, group_id, created_date } = submitData;
    let submittedData = {
      id: data.length + 1,
      code: code,
      material: material,
      ...
      <Content>
        ...
        <Block>
          <div className="nk-tb-list is-separate is-medium mb-3">
            <DataTableHead className="nk-tb-item">
              ...
              <DataTableRow size="lg">
                <span className="sub-text">GROUP ID</span>
              </DataTableRow>
              <DataTableRow size="lg">
        ...
        <Modal isOpen={modal.add} toggle={() => setModal({ add: false })} className="modal-dialog-centered" size="lg">
          <ModalBody>
            ...
            <div className="p-2">
              <h5 className="title">Add Material Record</h5>
              <div className="mt-4">
                <hr />
        ...
        <Modal isOpen={modal.edit} toggle={() => setModal({ edit: false })} className="modal-dialog-centered" size="lg">
          <ModalBody>
            ...
            <div className="p-2">
              <h5 className="title">Update Material Record</h5>
              <div className="mt-4">
                <hr />
