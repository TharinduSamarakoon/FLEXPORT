...
const List = () => {
  ...
  return (
    <React.Fragment>
      <Head title="MATERIAL CATEGORY"></Head>
      <Content>
        <BlockHead size="sm">
          <BlockBetween>
            <BlockHeadContent>
              ...
              Material Category Records List
              </BlockTitle>
            </BlockHeadContent>
            <BlockHeadContent>
        ...
        <Modal isOpen={modal.add} toggle={() => setModal({ add: false })} className="modal-dialog-centered" size="lg">
          <ModalBody>
            ...
            <div className="p-2">
              <h5 className="title">Add Material Category record</h5>
              <div className="mt-4">
                <hr />
        ...
        <Modal isOpen={modal.edit} toggle={() => setModal({ edit: false })} className="modal-dialog-centered" size="lg">
          <ModalBody>
            ...
            <div className="p-2">
              <h5 className="title">Update Material Category Record</h5>
              <div className="mt-4">
                <hr />
