...
const List = () => {
    ...
    if (onSearchText !== "") {
      const filteredObject = Data.filter((item) => {
        return (
          ...
          item.product.toLowerCase().includes(onSearchText.toLowerCase())
        );
      });
  ...
  const onFormSubmit = (submitData) => {
    const { code, product, group_id, created_date } = submitData;
    let submittedData = {
      id: data.length + 1,
      code: code,
      product: product,
      ...
      <Content>
        ...
        <Modal isOpen={modal.add} toggle={() => setModal({ add: false })} className="modal-dialog-centered" size="lg">
          <ModalBody>
            ...
            <div className="p-2">
              <h5 className="title">Add product Record</h5>
              <div className="mt-4">
                <hr />
        ...
        <Modal isOpen={modal.edit} toggle={() => setModal({ edit: false })} className="modal-dialog-centered" size="lg">
          <ModalBody>
            ...
            <div className="p-2">
              <h5 className="title">Update Product Record</h5>
              <div className="mt-4">
                <hr />
