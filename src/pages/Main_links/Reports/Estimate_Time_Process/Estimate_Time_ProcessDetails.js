...
const InvoiceDetails = ({ match }) => {
  ...
  return (
    <React.Fragment>
      <Head title="ESTIMATE TIME & PROCESS"></Head>
      {user && (
        <Content>
          <BlockHead>
            <BlockBetween className="g-3">
              <BlockHeadContent>
                <BlockTitle>
                ESTIMATE TIME AND PROCESS <strong className="text-primary small">#{user.orderId}</strong>
                </BlockTitle>
              ...
              <BlockHeadContent>
                <Link to={`${process.env.PUBLIC_URL}/extimate_t&p`}>
          ...
          <Block>
            <div className="invoice">
              <div className="invoice-action">
                <Link to={`${process.env.PUBLIC_URL}/extimate_t&p-print`} target="_blank">
