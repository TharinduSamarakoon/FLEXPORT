...
const FormElementsPage = () => {
  ...
  return (
    <React.Fragment>
      <Head title="ESTIMATE TIME & PROCESS" />
      <Content>
      <BlockHeadContent>
              <BlockTitle page>ESTIMATE TIME AND PROCESS</BlockTitle>
        ...
        <Block size="lg">
          ...
          <PreviewCard>
            ...
            <thead className="border prt-border">
            <tr>
                      ...
                      <tr>
                        <td className="border-left">1</td>
                          ...
                          <td>
                          <td><input className="form-control" type="text" id="default-0"  /></td>
                          <td><input className="form-control" type="text" id="default-0"  /></td>
                          <td><input className="form-control" type="text" id="default-0"  /></td>
                          </td>
                          <td className="border-right"><input className="form-control w-70 mt-1" type="text" id="default-0" /></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          ...
                          <td className=""><input className="form-control" type="text" id="default-0"  /></td>
                          <td className=""><input className="form-control" type="text" id="default-0"  /></td>
                          <td className=""><input className="form-control" type="text" id="default-0"  /></td>
                          </td>
                          <td className="border-right border-bottom"><input className="form-control w-70 mt-1" type="text" id="default-0" /></td>
                        </tr> 
