...
const FormElementsPage = () => {
  ...
  return (
    <React.Fragment>
      <Head title="JOB SPECIFICATION" />
      <Content>
      <BlockHeadContent>
              <BlockTitle page>JOB SPECIFICATION</BlockTitle>
...
{/* second row first col*/}
                  ...
                  <div className="form-control-wrap">
                    <input className="form-control" type="date" id="default-0" placeholder="Input name" />
                  </div>
                </FormGroup>
                    </Col>
                    <Col sm="6">
...
{/* forth row first col*/}
                <Row className="gy-4">
                  ...
                  <div className="form-control-wrap">
                    <input className="form-control" type="time" id="default-0" placeholder="Input name" />
                  </div>
                </FormGroup>
                    </Col>
                  </Row>
    ...
    <Row className="gy-4">
      ...
      <div className="g- align-center flex-wrap">
        <div className="g">
          ...
          <div className="mb-5">
            <Link to="/job_specification-details">
