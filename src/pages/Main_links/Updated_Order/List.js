...
const List = () => {
  ...
  return (
    <React.Fragment>
      <Head title="UPDATED ORDERS"></Head>
      <Content>
        <BlockHead size="sm">
          <BlockBetween>
            <BlockHeadContent>
          ...
          <div className="nk-tb-list is-separate is-medium mb-3">
            <DataTableHead className="nk-tb-item">
              ...
              <DataTableRow size="lg">
                <span className="sub-text">FOLLOW UP UPDATE</span>
              </DataTableRow>
        ...
        <Modal isOpen={modal.add} toggle={() => setModal({ add: false })} className="modal-dialog-centered" size="lg">
          <ModalBody>
            ...
            <div className="p-2">
              <h5 className="title">Add Follow Up Update Record</h5>
              <div className="mt-4">
                <hr />
                <Form className="row gy-4" noValidate onSubmit={handleSubmit(onFormSubmit)}>
                  <Col md="6">
                    <FormGroup>
                      <label className="form-label">Follow Up Update</label>
                      <input
                        className="form-control"
                        type="text"
                        name="update"
                        defaultValue={formData.update}
        ...
        <Modal isOpen={modal.edit} toggle={() => setModal({ edit: false })} className="modal-dialog-centered" size="lg">
          <ModalBody>
            ...
            <div className="p-2">
              <h5 className="title">Update Follow Up Update Record</h5>
              <div className="mt-4">
                <hr />
