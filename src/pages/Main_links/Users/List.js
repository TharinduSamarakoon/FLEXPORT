...
const List = () => {
    ...
    if (onSearchText !== "") {
      const filteredObject = Data.filter((item) => {
        return (
          ...
          item.created_date.toLowerCase().includes(onSearchText.toLowerCase())
        );
      });
  ...
  const onFormSubmit = (submitData) => {
    const { username, password, created_date } = submitData;
    let submittedData = {
      id: data.length + 1,
      username: username,
      password: password,
      ...
      <Content>
        ...
        <Modal isOpen={modal.add} toggle={() => setModal({ add: false })} className="modal-dialog-centered" size="lg">
          <ModalBody>
            ...
            <div className="p-2">
              <h5 className="title">Add User record</h5>
              <div className="mt-4">
                <hr />
        ...
        <Modal isOpen={modal.edit} toggle={() => setModal({ edit: false })} className="modal-dialog-centered" size="lg">
          <ModalBody>
            ...
            <div className="p-2">
              <h5 className="title">Update User Record</h5>
              <div className="mt-4">
                <hr />
