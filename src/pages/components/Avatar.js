            ...
            <PreviewCard>
              <Row className="g-4">
                <Col md="3">
                  ...
                  <ul className="preview-list g-2">
                    <li className="preview-item">
                      <UserAvatar theme="primary" text="SK"></UserAvatar>
                    </li>
                    <li className="preview-item">
                ...
                <Col md="3">
                  ...
                  <ul className="preview-list g-2">
                    <li className="preview-item">
                      <UserAvatar theme="primary" text="SK">
                ...
                <Col md="3">
                  ...
                  <ul className="preview-list g-2">
                    <li className="preview-item">
                      <UserAvatar theme="primary" text="SK" className="sq"></UserAvatar>
                    </li>
                    <li className="preview-item">
                ...
                <Col md="3">
                  ...
                  <ul className="preview-list g-2">
                    <li className="preview-item">
                      <UserAvatar theme="primary" text="SK" className="sq">
                        <div className="status dot dot-lg dot-success"></div>
                      </UserAvatar>
                    </li>
                    <li className="preview-item">
            ...
            <PreviewCard>
              <Row className="g-4">
                ...
                <Col className="col-12">
                  ...
                  <ul className="preview-list g-2">
                    <li className="preview-item">
                      <UserAvatar theme="primary-dim" text="SK"></UserAvatar>
                    </li>
                    <li className="preview-item">
            ...
            <PreviewCard>
              <Row className="g-4">
                <Col md="6">
                  ...
                  <ul className="preview-list g-2">
                    <li className="preview-item">
                      <UserAvatar text="SK" color="primary" className="xl"></UserAvatar>
                    </li>
                    <li className="preview-item">
                      <UserAvatar text="SK" color="primary" className="lg">
                        <div className="status dot dot-lg dot-success"></div>
                      </UserAvatar>
                    </li>
                    <li className="preview-item">
                    ...
                    <li className="preview-item">
                      <UserAvatar text="SK" color="primary"></UserAvatar>
                    </li>
                    <li className="preview-item">
                      <UserAvatar text="SK" color="primary" className="sm"></UserAvatar>
                    </li>
                    <li className="preview-item">
                ...
                <Col md="6">
                  ...
                  <ul className="preview-list g-2">
                    <li className="preview-item">
                      <UserAvatar text="SK" color="primary" className="xl sq"></UserAvatar>
                    </li>
                    <li className="preview-item">
                      <UserAvatar text="SK" color="primary" className="lg sq">
                        <div className="status dot dot-lg dot-success"></div>
                      </UserAvatar>
                    </li>
                    <li className="preview-item">
                    ...
                    <li className="preview-item">
                      <UserAvatar text="SK" color="primary" className="sm sq"></UserAvatar>
                    </li>
                    <li className="preview-item">
                ...
                <Col md="4" sm="6">
                  ...
                  <div className="user-card">
                    ...
                    <div className="user-info">
                      ...
                      <span className="sub-text">keith@flexport.com</span>
                    </div>
                  </div>
                </Col>
                <Col md="4" sm="6">
                  <OverlineTitle>User Card 2</OverlineTitle>
                  <div className="user-card">
                    <UserAvatar text="SK" theme="purple" className="sm"></UserAvatar>
